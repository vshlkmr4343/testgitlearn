package com.tradiuus.helper.imagepicker.imagePicker;
...
import com.tradiuus.helper.imagepicker.imageCompression.ImageCompression;
import com.tradiuus.helper.imagepicker.imageCompression.ImageCompressionListener;
...
public class ImagePicker {
    ...
    private Uri getCaptureImageOutputUri() {
        ...
        if (getImage != null) {
            ...
            outputFileUri = FileProvider.getUriForFile(activity != null ? activity : fragment.getActivity(),
                    ...
                    new File(getImage.getPath(), "IMG_" + String.valueOf(System.currentTimeMillis()) + ".png"));
        }
    ...
    private String getPickImageResultFilePath(Intent data) {
        ...
        if (isCamera) return (outputFileUri != null) ? outputFileUri.getPath() : "";
