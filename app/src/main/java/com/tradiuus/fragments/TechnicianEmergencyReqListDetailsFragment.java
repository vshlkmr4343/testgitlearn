...
public class TechnicianEmergencyReqListDetailsFragment extends Fragment implements View.OnClickListener {
    public static TechnicianEmergencyReqListDetailsFragment fragment;
    ...
    private void markComplete(Context context, final Job jobDetail) {
        Utility.uiThreadAlert(context, "Confirmation", "Do you want to mark as completed ? ", "Yes", "No", new Utility.OnDialogMultiButtonClick() {
            ...
            public void onOkayButtonClick() {
                try {
                    ((TechnicianEmergencyRequestActivity) getActivity()).completeJob(jobDetail, ((TechnicianEmergencyRequestActivity) getActivity()).selectedIndex);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void onCancelButtonClick() {
                ((TechnicianEmergencyRequestActivity) getActivity()).selectedIndex = -1;
            }
        });
    }
}
