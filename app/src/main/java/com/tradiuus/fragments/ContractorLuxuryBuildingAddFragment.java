...
public class ContractorLuxuryBuildingAddFragment extends Fragment implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_Add: {
                try {
                    ...
                    ((ContractorLuxuryBuildingsActivity) getActivity()).addJobs(ids);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void initViewLoad() {
        try {
            contractor = ((ContractorLuxuryBuildingsActivity) getActivity()).contractorImpl.mContractor;
            ...
            HashMap<String, Job> map = ((ContractorLuxuryBuildingsActivity) getActivity()).map;
