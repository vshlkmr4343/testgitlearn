...
public class TechnicianLuxuryBuildingListFragment extends Fragment implements View.OnClickListener {
    public static TechnicianLuxuryBuildingListFragment fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_technician_luxury_list, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_Add:
                ((TechnicianLuxuryBuildingsActivity) getActivity()).changeTitle();
                ((TechnicianLuxuryBuildingsActivity) getActivity()).replaceFragment(new TechnicianLuxuryBuildingAddFragment());
                break;
    ...
    private class LuxuryBuildingsAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                int dayDiff = Utility.getDayInCount(jobDetail.getUpdated_on(), jobDetail.getCreated_on());
                viewHolder.service_time_line.setText(dayDiff + " days");
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
