...
public class ContractorEmergencyReqListFragment extends Fragment implements View.OnClickListener {
    public static ContractorEmergencyReqListFragment fragment;
    ...
    private class EmergencyReqAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                Log.d("cost:","max:"+jobDetail.getJob_trade().getService().getService_max_price()+"min:"+jobDetail.getJob_trade().getService().getService_min_price());
                //"$" + mServiceParam.getPrice_max() + " - $" + mServiceParam.getPrice_min()
                if(Integer.parseInt(jobDetail.getJob_trade().getService().getService_max_price()) == 0 && Integer.parseInt(jobDetail.getJob_trade().getService().getService_max_price()) == 0 ){
                    ...
                    viewHolder.service_cost.setText("$"+jobDetail.getJob_trade().getService().getService_min_price()+"-$"+jobDetail.getJob_trade().getService().getService_max_price());
                }
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((ContractorEmergencyRequestActivity) getActivity()).contractor_dashboard_logut.setVisibility(View.VISIBLE);
                    ((ContractorEmergencyRequestActivity) getActivity()).replaceFragment(new ContractorEmergencyReqListDetailsFragment());
                }
            });
