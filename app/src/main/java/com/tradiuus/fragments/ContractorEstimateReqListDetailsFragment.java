...
public class ContractorEstimateReqListDetailsFragment extends Fragment implements View.OnClickListener {
    public static ContractorEstimateReqListDetailsFragment fragment;
    ...
    private void loadQS() {
        ...
        try {
            ...
            Log.d("Question Size:",""+question.size());
