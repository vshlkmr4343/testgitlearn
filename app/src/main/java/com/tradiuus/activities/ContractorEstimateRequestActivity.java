...
import com.tradiuus.fragments.ContractorEstimateReqListFragment;
...
public class ContractorEstimateRequestActivity extends BaseActivity implements ContractorImpl.OnRequestSyncChangedListener {
    ...
    protected void setActivityLayout() {
        ...
        this.context = ContractorEstimateRequestActivity.this;
    ...
    protected void initLoadCall() {
        ...
        replaceFragment(new ContractorEstimateReqListFragment());
    }
    ...
    public void onDataFetchDone() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    if (getSupportFragmentManager().getFragments().size() > 0 && getSupportFragmentManager().getFragments().get(0) instanceof ContractorEstimateReqListFragment) {
                        ((ContractorEstimateReqListFragment) getSupportFragmentManager().getFragments().get(0)).refreshUI();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
