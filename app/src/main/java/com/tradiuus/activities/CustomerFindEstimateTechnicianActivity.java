...
public class CustomerFindEstimateTechnicianActivity extends BaseActivity implements TechnicianImpl.OnTechnicianFundListener, OnMapReadyCallback {
    ...
    protected void setActivityLayout() {
        ...
        setContentView(R.layout.customer_findestimatetechnician_activity);
        this.context = CustomerFindEstimateTechnicianActivity.this;
        ...
        switch (view.getId()) {
            ...
            case R.id.technician_map: {
                try {
                    ...
                    if (isSelected) {
                        technician_map.setImageDrawable(getResources().getDrawable(R.drawable.list));
