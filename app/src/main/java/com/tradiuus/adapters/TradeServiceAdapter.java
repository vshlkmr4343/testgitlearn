...
public class TradeServiceAdapter extends BaseAdapter {
    ...
    public TradeServiceAdapter(Context context, List<Trade> items, OnItemClickListener onItemClickListener) {
        this.items = items;
    ...
    public TradeServiceAdapter(Context context, List<Trade> items, int lastSelectedIndex, OnItemClickListener onItemClickListener) {
        this.items = items;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtName.setText(trade.getService_name());
