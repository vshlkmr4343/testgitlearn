...
public class EstimateServiceAdapter extends BaseAdapter {
    ...
    public EstimateServiceAdapter(Context context, List<ServiceParam> items) {
        this.items = items;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    }

    public EstimateServiceAdapter(Context context, List<ServiceParam> items, OnItemClickListener onItemClickListener) {
        this.items = items;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
