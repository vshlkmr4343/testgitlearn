...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    public static final String VIDEO_DIRECTORY_NAME = "Tradiuus";
    ...
    private File getOutputMediaFile() {
        ...
        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), VIDEO_DIRECTORY_NAME);
        ...
        File mediaFile = new File(mediaStorageDir.getPath() + File.separator + "video_file.mp4");
        return mediaFile;
    }
